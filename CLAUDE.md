...
| Life mode                                      | singleton `channels.kind='life'` + `/api/life-session` and `/api/life-session/new`; right-edge UI in `public/app.js`; quick tags (`LIFE_TAGS`, sent as a `【label】` text prefix); full diagrams in [`docs/life-mode.md`](docs/life-mode.md)                                                                                                                                                                                                                 |
