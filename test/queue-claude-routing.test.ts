...
describe('queue Claude tmux routing', () => {
  ...
  it('waits for the old Pi RPC process to retire before completing a Claude turn', async () => {
    let retired = false;
    closeRpcSessionMock.mockImplementation(async () => {
